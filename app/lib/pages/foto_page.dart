...
import 'package:app/infra/flutter/dev/tools/bin/find_commit.dart';
import 'package:app/infra/flutter/packages/flutter/lib/scheduler.dart';
...
class _FotoPageState extends State<FotoPage>
  ...
  void onTakePictureButtonPressed() async {
    ...
    var response = await http.post(
      Uri.parse('https://m2.guilhermesperb.com.br/new'),
